...
public class LoginAdministratorView {
    ...
    public void initialize() {
        ...
        btnLogin.addActionListener( e -> {
            loginAdministratorController.login(username.getText(), String.valueOf(password.getPassword()));
            username.setText("");
            password.setText("");
        });
